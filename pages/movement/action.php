...
if($action=='moveLine' && $id){
	...
	if($lineId){
		...
		if($row['amount']==$row['issueAmount']){
			...
			$newLocation = $row['issue_location'];
			$productUmo = $row['productUmo'];
			$resourceNr = $row['issue_resource'];
			
			$new_assistant_amount = $row['issue_assistant_amount'];
			$org_assistant_amount = $row['assistant_amount'];
			...
			$form_data = array(
				...
				'assistant_amount' => $new_assistant_amount,
				'action' => 20,	
				'issueActivityDate' => '',
				'issue_location' => '',
				'issueAmount' => '',
				...
				'productNr' => $productNr,
				'amount' => $amount*(-1),
				'assistant_amount' => $new_assistant_amount*(-1),
			...
			$leftAmountAssistant = $row['assistant_amount']-$row['issue_assistant_amount'];
				
			$form_data = array(
			'activityDate' => $actionDate,
			'location' => $changeLocationAll,
			'amount' => $amount,	
			'assistant_amount' => $new_assistant_amount,
			'activityDate' => $row['issueActivityDate'],
			...
			'assistantUmo' => $assistantUmo,
			'amount' => $leftAmount,
			'assistant_amount' => $leftAmountAssistant,
			'enteredDate' => date('Y-m-d H:i:s'),
			'location' => $orgLocation,
			'enteredBy' => $myid,
			'thisDate' => $mThisDate,
