...
$(document).ready(function () {
    $('#add_comment').on('submit', function(e) {
        ...
        $.ajax({
            url : '/pages/additional_services/post.php?r=addComment&id=<?=$id;?>',
            type: "POST",
            ...
            success: function (data) {
				...
				$('#contenthere').load('/pages/additional_services/additional_services.php?view=edit&id=<?=$edit;?>&res=done');
...
$query = mysqli_query($conn, "SELECT comment FROM additional_services_line WHERE id='".intval($id)."'") or die (mysqli_error($conn));
