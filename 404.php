...
<head>
	...
	<META HTTP-EQUIV="refresh" CONTENT="3;URL=<?=$companyWEB;?>">
		...
		<div style="width:100%;">
				...
				<div class="container vertical-divider">
				  <div class="column one-third" style="color: white;">
						<span style="font-weight: lighter; font-size: 2em;">error 404</span><br /><br />
						<span style="font-weight: lighter; font-size: 1.6em;">Jūsu meklētā lapa nav atrasta!</span>
				  </div>
...
<a class="btn btn-danger"href="index" style="margin-left: 30px; margin-top: 30px;">UZ SĀKUMU</a>
