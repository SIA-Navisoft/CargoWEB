...
<body>
		...
		<div style="width:100%;">
				...
				<div class="container vertical-divider">
				  <div class="column one-third" style="color: white;">
						...
						<span style="font-weight: lighter; font-size: 1.6em;">Jums ir liegta piekļuve šai vietnei!</span>
				  </div>
	...
	<br>
	<span style="font-weight: lighter; font-size: 1.6em; margin-left: 30px;">
		Lai nodrošinātu piekļuvi, sazinieties ar administratoru.
	</span>
